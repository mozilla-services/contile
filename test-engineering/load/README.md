...
The load test framework was originally developed in isolation using Molotov, see
[contile-loadtests][1].
...
[23]: ./setup_k8s.sh
[24]: ./kubernetes-config/locust-master-controller.yml
[25]: ./kubernetes-config/locust-master-service.yml
[26]: ./kubernetes-config/locust-worker-controller.yml
